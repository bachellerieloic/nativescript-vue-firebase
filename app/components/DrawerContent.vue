...
<GridLayout rows="auto, *" class="nt-drawer__content">
            ...
            <ScrollView row="1" class="nt-drawer__body">
                <StackLayout>
                    <GridLayout columns="auto, *" :class="'nt-drawer__list-item' + (selectedPage === 'Login' ? ' -selected': '')" @tap="onNavigationItemTap(Login)">
                    ...
                    <GridLayout columns="auto, *" :class="'nt-drawer__list-item' + (selectedPage === 'Home' ? ' -selected': '')" @tap="onNavigationItemTap(Home)">
                        <Label col="0" text.decode="&#xf015;" class="nt-icon fas"></Label>
                        <Label col="1" text="My Smoothies" class="p-r-10"></Label>
                    </GridLayout>
